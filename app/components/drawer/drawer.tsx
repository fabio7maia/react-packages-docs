  ...
  return (
    <>
      <div className="flex flex-row-reverse top-20">
        <div className="flex w-64 h-screen right-0" />
      </div>
      <div className="flex flex-no-wrap flex-row-reverse fixed right-0 h-screen top-20">
        {/* Sidebar starts */}
        {/* Remove class [ hidden ] and replace [ sm:flex ] with [ flex ] */}
        <div
          className={`w-64 fixed sm:relative bg-gray-800 shadow md:h-full flex-col justify-between hidden sm:flex`}
        >
          <div className="px-8">
        ...
        <div className="w-64 z-40 fixed bg-gray-800 shadow md:h-full flex-col justify-between sm:hidden  transition duration-150 ease-in-out">
          <div
            className={`h-10 w-10 bg-gray-800 fixed mt-16 flex items-center shadow rounded-tl rounded-bl justify-center cursor-pointer ${
              show ? "right-64" : "right-0"
            }`}
